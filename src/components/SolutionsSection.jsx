...
function GenericSolutionsSection(props) {
    ...
    return (
        <>
        <div className="w-full overflow-hidden mx-auto flex justify-between  items-center px-[80px] relative max-md:px-5 gap-10 pt-[80px] max-md:pt-[40px] max-md:flex-col" id="techSolutionsSection">
     ...
     {techSolutions.caseStudies !== undefined &&   <div className="!w-[100%] overflow-hidden relative left-[100px] max-md:left-[60px] py-[80px] !mx-0 font-semibold !text-2xl text-[#292929] max-md:text-xl">
